...
angular.module('angularApp')
  .controller('MainCtrl', ['$scope','$http','ServiceMsg','$cookieStore','$cookies','$location','$firebase',function ($scope, $http, ServiceMsg, $cookieStore, $cookies, $location, $firebase) {
    ...
    $scope.isActive = function(route) {
  	...
  	//FIREBASE
    var ref = new Firebase('https://fundraising-mandala-2018.firebaseio.com/' + firebaseCollectionName);
	...
	$scope.confirmDonation = function (i,donation) {
        var refUpd = new Firebase('https://fundraising-mandala-2018.firebaseio.com/'+firebaseCollectionName+'/'+i);
	...
	$scope.removeDonation = function (i) {
        var refDel = new Firebase('https://fundraising-mandala-2018.firebaseio.com/'+firebaseCollectionName+'/'+i);
        refDel.remove();
    };
    ...
    */
    var datiEmail = {
      ...
      message: "New Order: " + Dati.codeTr + ". " + Dati.name + " " + Dati.surname + " qta: " + Dati.qta + " lang: " + Dati.lang + " payment_type: " + Dati.payment_type + " "
                ...
                $http.post('http://178.62.133.175/lungtamail.it/EMLcms/web/it/send/', datiEmail).
